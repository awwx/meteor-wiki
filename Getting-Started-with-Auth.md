...
4. Turn off default mutators or wrap them to check permissions ([here's](https://github.com/meteor/meteor/blob/5ac6ee0d6edbfe3cce93ad3eb50274904968f06f/examples/todos/server/access_control.js) what we did for todos)
